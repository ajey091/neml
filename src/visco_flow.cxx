...
{
  return std::make_unique<GPowerLaw>(
...
{
  return std::make_unique<PerzynaFlowRule>(
...
{
  return std::make_unique<ConstantFluidity>(
      params.get_object_parameter<Interpolate>("eta")
      ); 
}
...
{
  return std::make_unique<SaturatingFluidity>(
...
{
  return std::make_unique<ChabocheFlowRule>(
      params.get_object_parameter<YieldSurface>("surface"),
...
{
  return std::make_unique<YaguchiGr91FlowRule>(); 
}
