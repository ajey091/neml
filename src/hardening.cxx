...
{
  return std::make_unique<LinearIsotropicHardeningRule>(
...
{
  return std::make_unique<InterpolatedIsotropicHardeningRule>(
...
{
  return std::make_unique<VoceIsotropicHardeningRule>(
      params.get_object_parameter<Interpolate>("s0"),
...
{
  return std::make_unique<PowerLawIsotropicHardeningRule>(
      params.get_object_parameter<Interpolate>("s0"),
...
{
  return std::make_unique<CombinedIsotropicHardeningRule>(
...
{
  return std::make_unique<LinearKinematicHardeningRule>(
...
{
  return std::make_unique<CombinedHardeningRule>(
...
{
  return std::make_unique<ConstantGamma>(
...
{
  return std::make_unique<SatGamma>(
...
{
  return std::make_unique<Chaboche>(
      params.get_object_parameter<IsotropicHardeningRule>("iso"),
